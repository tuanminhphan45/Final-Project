...
DATA_URL = {
    "train": "https://www.mediafire.com/file/x3rrbe4hwp04e6w/train_val_videos.zip",
    "test": "https://www.mediafire.com/file/czh8sezbo9s4692/test_videos.zip/file",
}
...
if __name__ == "__main__":
    ...
    storage_dir = Path("/storage/student10/vidcaption/msrvtt_videos")
    download_dir = storage_dir.parent / "msrvtt_download"
